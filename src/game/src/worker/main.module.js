...
import * as _modules_mage_mage_module__WEBPACK_IMPORTED_MODULE_2__ from '../../worker/modules/mage/mage.module.js';
import * as _modules_resources_resource_pool_module__WEBPACK_IMPORTED_MODULE_3__ from '../../worker/modules/resources/resource-pool.module.js';
import * as _modules_actions_actions_module__WEBPACK_IMPORTED_MODULE_4__ from '../../worker/modules/actions/actions.module.js';
import * as _modules_attributes_attributes_module__WEBPACK_IMPORTED_MODULE_5__ from '../../worker/modules/attributes/attributes.module.js';
import * as _modules_items_shop_module__WEBPACK_IMPORTED_MODULE_6__ from '../../worker/modules/items/shop.module.js';
import * as _modules_inventory_inventory_module__WEBPACK_IMPORTED_MODULE_7__ from '../../worker/modules/inventory/inventory.module.js';
import * as _modules_property_property_module__WEBPACK_IMPORTED_MODULE_8__ from '../../worker/modules/property/property.module.js';
import * as _modules_magic_spells_module__WEBPACK_IMPORTED_MODULE_9__ from '../../worker/modules/magic/spells.module.js';
import * as _modules_workshop_crafting_module__WEBPACK_IMPORTED_MODULE_10__ from '../../worker/modules/workshop/crafting.module.js';
import * as _modules_workshop_plantations_module__WEBPACK_IMPORTED_MODULE_11__ from '../../worker/modules/workshop/plantations.module.js';
import * as _modules_social_guilds_module__WEBPACK_IMPORTED_MODULE_12__ from '../../worker/modules/social/guilds.module.js';
import * as _shared_modules_unlock_notifications_module__WEBPACK_IMPORTED_MODULE_13__ from '../../worker/shared/modules/unlock-notifications.module.js';
import * as _modules_general_random_events_module__WEBPACK_IMPORTED_MODULE_14__ from '../../worker/modules/general/random-events.module.js';
import * as _modules_general_temporary_effects_module__WEBPACK_IMPORTED_MODULE_15__ from '../../worker/modules/general/temporary-effects.module.js';
import * as _modules_map_map_module__WEBPACK_IMPORTED_MODULE_16__ from '../../worker/modules/map/map.module.js';
import * as _shared_modules_hotkeys_module__WEBPACK_IMPORTED_MODULE_17__ from '../../worker/shared/modules/hotkeys.module.js';
import * as _shared_modules_monitoring_module__WEBPACK_IMPORTED_MODULE_18__ from '../../worker/shared/modules/monitoring.module.js';
import * as _shared_modules_rules_module__WEBPACK_IMPORTED_MODULE_19__ from '../../worker/shared/modules/rules.module.js';
import * as _modules_items_courses_module__WEBPACK_IMPORTED_MODULE_20__ from '../../worker/modules/items/courses.module.js';
