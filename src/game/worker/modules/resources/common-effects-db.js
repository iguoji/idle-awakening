...
var registerCommomEffects = function registerCommomEffects() {
  index.gameEffects.registerEffect('rest_efficiency', {
    name: 'Rest Efficiency',
    defaultValue: 1.,
    minValue: 1
  });
  index.gameEffects.registerEffect('begging_efficiency', {
    name: 'Begging Efficiency',
    defaultValue: 1.,
    minValue: 1
  });
  index.gameEffects.registerEffect('clean_stable_efficiency', {
    name: 'Clean Stable Efficiency',
    defaultValue: 1.,
    minValue: 1
  });
  index.gameEffects.registerEffect('gathering_efficiency', {
    name: 'Gathering Efficiency',
    defaultValue: 1.,
    minValue: 1
  });
  index.gameEffects.registerEffect('gathering_perception', {
    name: 'Gathering Perception',
    defaultValue: 1.,
    minValue: 1,
    saveBalanceTree: true
  });
  index.gameEffects.registerEffect('gathering_low_chance', {
  ...
  index.gameEffects.registerEffect('gathering_herbs_amount', {
    name: 'Herbs Gathered',
    defaultValue: 1.,
    minValue: 1,
    description: 'Multiplier to amount of herbs that can be found'
  });
  index.gameEffects.registerEffect('read_books_efficiency', {
    name: 'Read Books Efficiency',
    defaultValue: 1.,
    minValue: 1
  });
  index.gameEffects.registerEffect('plain_learn_rate', {
    name: 'Plain Learn Bonus',
    description: 'Raw bonus to XP gained to action (not multiplied by other multipliers)',
    defaultValue: 0,
    minValue: 0
  });
  index.gameEffects.registerEffect('books_learning_rate', {
  ...
  index.gameEffects.registerEffect('spiritual_learning_rate', {
  ...
  index.gameEffects.registerEffect('mental_training_learning_rate', {
  ...
  index.gameEffects.registerEffect('social_training_learning_rate', {
  ...
  index.gameEffects.registerEffect('max_focus_time', {
    name: 'Max focus time',
    defaultValue: 300.,
    minValue: 300
  });
  index.gameEffects.registerEffect('coins_earned_bonus', {
    name: 'Coins Earning Bonus',
    defaultValue: 1.,
    minValue: 1
  });
  index.gameEffects.registerEffect('physical_training_learn_speed', {
  ...
  index.gameEffects.registerEffect('routine_learning_speed', {
  ...
  index.gameEffects.registerEffect('yoga_learn_speed', {
  ...
  index.gameEffects.registerEffect('crafting_efficiency', {
    name: 'Crafting Efficiency',
    defaultValue: 1.,
    minValue: 1.,
    saveBalanceTree: true
  });
  index.gameEffects.registerEffect('alchemy_efficiency', {
    name: 'Alchemy Efficiency',
    defaultValue: 1.,
    minValue: 1.,
    saveBalanceTree: true
  });
  index.gameEffects.registerEffect('learning_rate', {
    name: 'Learning Rate',
    defaultValue: 1.,
    minValue: 1,
    saveBalanceTree: true,
  ...
  index.gameEffects.registerEffect('walking_learning_rate', {
  ...
  // Aspects
  index.gameEffects.registerEffect('aspect_attribute_strength', {
    name: 'Physical Intensity',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('aspect_attribute_charisma', {
    name: 'Social Intensity',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('aspect_attribute_patience', {
  ...
  index.gameEffects.registerEffect('aspect_attribute_strength_reduction', {
    name: 'Physical Intensity Mult.',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('aspect_attribute_charisma_reduction', {
    name: 'Social Intensity Mult.',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('aspect_attribute_patience_reduction', {
    name: 'Patience Intensity Mult.',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('courses_knowledge_discount', {
    name: 'Courses Knowledge Discount',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('social_actions_discount', {
  ...
  index.gameEffects.registerEffect('physical_actions_discount', {
  ...
  index.gameEffects.registerEffect('mental_actions_discount', {
  ...
  index.gameEffects.registerEffect('magical_actions_discount', {
  ...
  index.gameEffects.registerEffect('routine_actions_discount', {
  ...
  index.gameEffects.registerEffect('courses_learning_speed', {
    name: 'Courses Learning Speed',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('reductive_courses_power', {
    name: 'Reductive Courses Power',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('max_map_level', {
    name: 'Max Map Level',
    defaultValue: 1.,
    minValue: 1.
  });
  index.gameEffects.registerEffect('max_wells', {
    name: 'Max Wells',
    defaultValue: 0.,
    minValue: 0.
  });
  index.gameEffects.registerEffect('max_wells_per_water_pump', {
    name: 'Max Wells Per Water Pump',
    defaultValue: 0.,
    minValue: 0.
  });
  index.gameEffects.registerEffect('spell_xp_rate', {
    name: 'Spell XP Gain',
  ...
  index.gameEffects.registerEffect('land_purchase_discount', {
    name: 'Land Discount',
    defaultValue: 1,
    minValue: 1
  });
  index.gameEffects.registerEffect('urn_storage_bonus', {
    name: 'Urns storage bonus',
    defaultValue: 1.,
    minValue: 1,
    hasCap: false
  });
  index.gameEffects.registerEffect('crafting_materials_discount', {
  ...
  index.gameEffects.registerEffect('alchemy_materials_discount', {
  ...
  index.gameEffects.registerEffect('map_generation_discount', {
