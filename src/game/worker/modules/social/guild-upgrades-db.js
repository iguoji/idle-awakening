...
var registerGuildUpgrades = function registerGuildUpgrades() {
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_merchant_codex', {
    ...
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_merchants') > 0;
    },
    attributes: {
      isCollectable: false,
      tier: 1
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_golden_streams', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Golden Streams',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_efficient_work', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_hagglers_charm', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Hagglers Charm',
    description: 'Lower prices in the shop, saving money on every purchase',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_merchants') > 4;
    },
    attributes: {
      isCollectable: false,
      tier: 2
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_vault_expansion', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_treasury_overflow', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Treasury Overflow',
    description: 'Boost both your coin cap and income, stacking with previous upgrades',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_merchants') > 9;
    },
    attributes: {
      isCollectable: false,
      tier: 3
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_knowledge_seeker', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Knowledge Seeker',
    description: 'Increase the amount of knowledge you gain from intellectual pursuits.',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_scholars') > 0;
    },
    attributes: {
      isCollectable: false,
      tier: 1
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_routine_mastery', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_mental_acumen', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Mental Acumen',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_physical_insight', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Physical Insight',
    description: 'Boost the learning speed of physical actions, improving your body\'s capabilities',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_scholars') > 4;
    },
    attributes: {
      isCollectable: false,
      tier: 2
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_scholars_reservior', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_mana_well', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Mana Well',
    description: 'Expand your maximum mana reserves, enabling more powerful spells.',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_mages') > 0;
    },
    attributes: {
      isCollectable: false,
      tier: 1
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_spiritual_enlightenment', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_arcane_expertise', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_restorative_surge', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Restorative Surge',
    description: 'Improve the effectiveness of healing magic, ensuring faster recovery',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_mages') > 4;
    },
    attributes: {
      isCollectable: false,
      tier: 2
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_illusionists_edge', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_mana_overflow', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Mana Overflow',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_alchemical_mastery', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Alchemical Mastery',
    description: 'Increase the efficiency of the \'Alchemy\' action, creating more potent results',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_herbalists') > 0;
    },
    attributes: {
      isCollectable: false,
      tier: 1
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_green_fingers', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Green Fingers',
    description: 'Boost the output of plantations, ensuring richer harvests of valuable plants',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_herbalists') > 0 && index.gameResources.getResource('plantation_slots').income > 0;
    },
    attributes: {
      isCollectable: false,
      tier: 1
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_effortless_routine', {
    tags: ["guild-upgrade", "purchaseable"],
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_herbalists_insight', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Herbalist\'s Insight',
    description: 'Enhance the effectiveness of herb gathering, finding rarer and higher-quality plants',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_herbalists') > 4;
    },
    attributes: {
      isCollectable: false,
      tier: 2
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_extra_alembic', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Extra Alembic',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_potion_proficiency', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Potion Proficiency',
    description: 'Brew additional potions for the same resource cost, maximizing your efficiency',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_herbalists') > 9;
    },
    attributes: {
      isCollectable: false,
      tier: 3
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_crafting_expertise', {
    tags: ["guild-upgrade", "purchaseable"],
    ...
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_artisans') > 0;
    },
    attributes: {
      isCollectable: false,
      tier: 1
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_endless_energy', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Endless Energy',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_vital_recovery', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Vital Recovery',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_labour_efficiency', {
    tags: ["guild-upgrade", "purchaseable"],
    ...
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_artisans') > 4;
    },
    attributes: {
      isCollectable: false,
      tier: 2
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_physical_insight_2', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Physical Insight',
  ...
  index.gameEntity.registerGameEntity('guild_upgrades_master_crafter', {
    tags: ["guild-upgrade", "purchaseable"],
    name: 'Master Crafter',
    description: 'Significantly boost the efficiency of crafting, turning you into a true artisan of creation.',
    level: 0,
    unlockCondition: function unlockCondition() {
      return index.gameEntity.getLevel('guild_artisans') > 9;
    },
    attributes: {
      isCollectable: false,
      tier: 3
