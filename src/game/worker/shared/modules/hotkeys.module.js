...
var HotkeysModule = /*#__PURE__*/function (_GameModule) {
  function HotkeysModule() {
    ...
    _this.hotKeys = {};
    _this.eventHandler.registerHandler('query-all-hotkeys', function (payload) {
      var label = "all-hotkeys";
      if (payload !== null && payload !== void 0 && payload.suffix) {
        label = "".concat(label, "-").concat(payload === null || payload === void 0 ? void 0 : payload.suffix);
      }
      _this.eventHandler.sendData(label, _this.hotKeys);
    });
    _this.eventHandler.registerHandler('update-hotkey', function (payload) {
      ...
      _this.eventHandler.sendData('all-hotkeys-all', _this.hotKeys);
    });
    return _this;
  }
