...
/* harmony export */   AlchemyListDetails: () => (/* binding */ AlchemyListDetails),
/* harmony export */   AlchemyWrap: () => (/* binding */ AlchemyWrap),
...
/* harmony import */ var _alchemy_jsx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./alchemy.jsx */ "./src/components/workshop/alchemy/alchemy.jsx");
...
var AlchemyWrap = function AlchemyWrap(_ref) {
  ...
  onMessage('new-unlocks-notifications-alchemy', function (payload) {
  ...
  var setAutotriggerPriority = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (priority) {
    ...
    if (listData) {
      var newList = (0,lodash__WEBPACK_IMPORTED_MODULE_9__.cloneDeep)(listData);
    ...
    if (listDetails !== null && listDetails !== void 0 && listDetails.listData && listDetails !== null && listDetails !== void 0 && listDetails.isEdit) {
      if (id) {
        ...
        if (!listDetails.listData.recipes.find(function (one) {
          ...
          var newList = (0,lodash__WEBPACK_IMPORTED_MODULE_9__.cloneDeep)(listDetails.listData);
  ...
  }, "Info")) : null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_alchemy_jsx__WEBPACK_IMPORTED_MODULE_7__.Alchemy, {
    filterId: 'alchemy',
    setItemDetails: setItemDetails,
    setItemLevel: setItemLevel,
    newUnlocks: (_newUnlocks$workshop = newUnlocks.workshop) === null || _newUnlocks$workshop === void 0 || (_newUnlocks$workshop = _newUnlocks$workshop.items) === null || _newUnlocks$workshop === void 0 || (_newUnlocks$workshop = _newUnlocks$workshop.alchemy) === null || _newUnlocks$workshop === void 0 ? void 0 : _newUnlocks$workshop.items,
  ...
  }, listDetails !== null && listDetails !== void 0 && listDetails.listData && (listDetails !== null && listDetails !== void 0 && listDetails.isEdit || !detailOpened) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(AlchemyListDetails, {
...
var ItemDetails = function ItemDetails(_ref12) {
  var itemId = _ref12.itemId,
    category = _ref12.category,
    setItemDetails = _ref12.setItemDetails;
  var worker = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_worker_context__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
var AlchemyListDetails = function AlchemyListDetails(_ref13) {
  ...
  var listDetails = _ref13.listDetails,
    isEditing = _ref13.isEditing,
    onUpdateActionFromList = _ref13.onUpdateActionFromList,
    onDropActionFromList = _ref13.onDropActionFromList,
    onUpdateListValue = _ref13.onUpdateListValue,
    onAddAutotriggerRule = _ref13.onAddAutotriggerRule,
    onSetAutotriggerRuleValue = _ref13.onSetAutotriggerRuleValue,
    onDeleteAutotriggerRule = _ref13.onDeleteAutotriggerRule,
    setAutotriggerPriority = _ref13.setAutotriggerPriority,
    onSetAutotriggerPattern = _ref13.onSetAutotriggerPattern,
    onCloseList = _ref13.onCloseList,
    onToggleAutotrigger = _ref13.onToggleAutotrigger;
  var worker = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_worker_context__WEBPACK_IMPORTED_MODULE_1__["default"]);
  ...
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_shared_rules_list_jsx__WEBPACK_IMPORTED_MODULE_10__["default"], {
    isEditing: isEditing,
...
var GeneralStats = function GeneralStats(_ref14) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_3___default()), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: 'block'
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "Alchemy"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: 'hint separated'
  }, "You can brew multiple items at once, if you have enough available alchemy slots. Assigning more effort to crafting of specific resource will make crafting faster but more wasteful"), !data.isProducingEffort ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: 'hint warning yellow'
  }, "Alchemy requires Alchemy Effort, which is generated by specific actions. To be able to brew something, make sure you are generating Alchemy Effort.") : null, !data.hasSlots ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: 'hint warning yellow'
  }, "Each potion brewing require alchemy slot. Make sure you've purchased corresponding furniture") : null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: 'block'
...
//# sourceURL=webpack://idlemancery-v2-reworked/./src/components/workshop/alchemy/index.jsx?
