...
/* harmony export */   ACTION_CATS: () => (/* binding */ ACTION_CATS),
/* harmony export */   getRankId: () => (/* binding */ getRankId),
...
var registerGameAction = function registerGameAction(id, options) {
  ...
  if (primaryAttribute) {
    ...
    if (!options.resourceModifier.effectDeps.includes(primaryAttribute)) {
      ...
      options.resourceModifier.effectDeps.push("aspect_".concat(primaryAttribute));
    }
