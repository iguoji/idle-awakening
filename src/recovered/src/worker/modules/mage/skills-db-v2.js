...
var registerSkillsStage1 = function registerSkillsStage1() {
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_intense_training', {
    ...
    unlockBySkills: [{
      id: "skill_physical_discount",
      level: 8
    }, {
      id: "skill_mental_discount",
      level: 8
    }, {
      id: "skill_routine_discount",
      level: 8
    }, {
      id: "skill_general_training_-0",
      level: 1
    }, {
      id: "skill_general_training_11",
      level: 1
    }],
    attributes: {
      isCollectable: false
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_mental_learn_rate', {
    ...
    unlockBySkills: [{
      ...
      id: "skill_reductive_courses_power",
      level: 8
    }],
    attributes: {
      isCollectable: false
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_physical_talents', {
    ...
    unlockBySkills: [{
      ...
      id: "skill_general_training_9",
      level: 1
    }, {
      id: "skill_general_training_8",
      level: 1
    }],
    unlockCondition: function unlockCondition() {
      return true;
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_crafting_efficiency', {
    ...
    unlockBySkills: [{
      id: 'skill_energizer_2',
      level: 8
    }, {
      id: 'skill_oak_heart_2',
      level: 8
    }, {
      id: 'skill_physical_actions_discount_3',
      level: 8
    }],
    unlockCondition: function unlockCondition() {
      return game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.getLevel('shop_item_crafting_courses') > 0;
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_empathy', {
    ...
    unlockBySkills: [{
      ...
      id: "skill_coin_income",
      level: 8
    }, {
      id: "skill_trade_efficiency",
      level: 8
    }, {
      id: "skill_general_training_5",
      level: 1
    }, {
      id: "skill_general_training_6",
      level: 1
    }],
    attributes: {
      isCollectable: false
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_improved_perception', {
    ...
    unlockBySkills: [{
      ...
      id: "skill_plantations_efficiency",
      level: 8
    }],
    attributes: {
      isCollectable: false
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_arcane_mind', {
    ...
    unlockBySkills: [{
      ...
      id: "skill_knowledge_generation2",
      level: 4
    }],
    unlockCondition: function unlockCondition() {
      // console.log('ACTLVL: ', )
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_mysticism', {
    ...
    unlockBySkills: [{
      ...
      id: "skill_general_training_1",
      level: 1
    }, {
      id: "skill_general_training_3",
      level: 1
    }],
    unlockCondition: function unlockCondition() {
      // console.log('ACTLVL: ', )
  ...
  game_framework__WEBPACK_IMPORTED_MODULE_0__.gameEntity.registerGameEntity('skill_learning_mastery', {
    ...
    unlockBySkills: [{
      id: "skill_spiritual_learning_rate",
      level: 8
    }, {
      id: "skill_knowledge_gain_2",
      level: 8
    }, {
      id: "skill_mana_gain_2",
      level: 8
    }],
    unlockCondition: function unlockCondition() {
      // console.log('ACTLVL: ', )
...
//# sourceURL=webpack://idlemancery-v2-reworked/./src/worker/modules/mage/skills-db-v2.js?
